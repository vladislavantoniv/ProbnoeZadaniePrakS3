// file name: TestTypeServiceImpl.java
...
public class TestTypeServiceImpl implements TestTypeService {
    ...
    public TestTypeDTO updateTestType(Long id, TestTypeDTO testTypeDTO) {
        ...
        // Проверка уникальности кода для других типов анализов
    ...
    public void deleteTestType(Long id) {
        ...
        if (!testType.getTests().isEmpty()) {
            throw new com.lab.exception.BusinessLogicException(
                    "Невозможно удалить тип анализа, так как существуют связанные тесты. Сначала удалите все связанные тесты."
            );
        }
